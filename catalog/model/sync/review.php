...
class Review extends \Opencart\System\Engine\Model {
	 ...
	 *
	 * $review_id = $this->model_sync_review->addReview($review_data);
	 */
	public function addReview(array $data): int {
		...
		$this->model_sync_product->editRating($data['product_id'], $this->model_sync_review->getRating($data['product_id']));
	 ...
	 * $this->load->model('catalog/review');
	 *
	 * $this->model_sync_review->editReview($review_id, $review_data);
	 */
	 ...
	 * $this->load->model('catalog/review');
	 *
	 * $this->model_sync_review->deleteReview($review_id);
	 */
	public function deleteReview(int $review_id): void {
		...
		if ($review_info) {
			...
			$this->model_sync_product->editRating($review_info['product_id'], $this->model_sync_review->getRating($review_info['product_id']));
	 ...
	 * $this->load->model('catalog/review');
	 *
	 * $review_info = $this->model_sync_review->getReview($review_id);
	 */
	 ...
	 * $this->load->model('catalog/review');
	 *
	 * $rating_info = $this->model_sync_review->getRating($product_id);
	 */
	 ...
	 * $this->load->model('catalog/review');
	 *
	 * $results = $this->model_sync_review->getReviews($filter_data);
	 */
	 ...
	 * $this->load->model('catalog/review');
	 *
	 * $review_total = $this->model_sync_review->getTotalReviews($filter_data);
	 */
	 ...
	 * $this->load->model('catalog/review');
	 *
	 * $review_total = $this->model_sync_review->getTotalReviewsAwaitingApproval());
	 */
